...
import org.corpus_tools.pepperModules.ToolboxTextModules.ToolboxTextExporter;
 ...
 * {@link ToolboxTextExporter} class. Feel free to adapt and enhance this test class
...
public class ToolboxTextExporterTest extends PepperExporterTest {
	...
	public void test_DummyImplementation() {
		...
		File superCorpus = new File(getTempPath("ToolboxTextExporter").getAbsolutePath() + "/rootCorpus");
