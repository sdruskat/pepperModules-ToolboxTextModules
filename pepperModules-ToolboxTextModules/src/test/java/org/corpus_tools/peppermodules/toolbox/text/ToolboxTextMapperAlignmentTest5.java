...
public class ToolboxTextMapperAlignmentTest5 {
	...
	public void testFixMissingMorphAnnotations() {
		...
		List<SToken> sortedLexTokens = graph.getSortedTokenByText(tokenList);
		assertEquals("BROKEN_ALIGNMENT", sortedLexTokens.get(sortedLexTokens.size() - 1).getAnnotation("toolbox::ta").getValue());
	}
