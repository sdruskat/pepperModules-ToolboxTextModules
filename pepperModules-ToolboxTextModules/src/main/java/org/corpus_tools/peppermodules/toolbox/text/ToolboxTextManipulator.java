 ...
 */
@Component(name = "ToolboxTextManipulatorComponent", factory = "PepperManipulatorComponentFactory")
public class ToolboxTextManipulator extends PepperManipulatorImpl {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public ToolboxTextManipulator() {
		super();
		setName("ToolboxTextManipulator");
	 ...
	 */
	public static class ToolboxTextMapper extends PepperMapperImpl implements GraphTraverseHandler {
		/**
		...
		public DOCUMENT_STATUS mapSDocument() {
			...
			// depth-first order top down. The id 'ToolboxTextTraversal' is used for
			...
			getDocument().getDocumentGraph().traverse(roots, GRAPH_TRAVERSE_TYPE.TOP_DOWN_DEPTH_FIRST, "ToolboxTextTraversal", this);
